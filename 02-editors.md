...
Emacs because even though there is a higher learning curve, it recognizes the language that I write in
...
Some useful are:
* CMD + 1 => Toggle comments
* CMD + F5 => debugger
* F5 => run entire program
* CMD + Enter (while highlighting something) => run selected
